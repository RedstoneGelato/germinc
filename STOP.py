...
motor2 = PowerfulBLDCDriver(i2c, 32)
...
motor3 = PowerfulBLDCDriver(i2c, 28)
...
motor4 = PowerfulBLDCDriver(i2c, 27)
...
motor5 = PowerfulBLDCDriver(i2c, 25)
motor5.set_current_limit_foc(65536)  # set current limit to 1 amp (only works in FOC mode)
motor5.set_id_pid_constants(1500, 200)
motor5.set_speed_pid_constants(4e-2, 4e-4, 3e-2)
motor5.set_position_pid_constants(275, 0, 0)
motor5.set_position_region_boundary(250000)
motor5.configure_operating_mode_and_sensor(3, 1)
motor5.configure_command_mode(12)
