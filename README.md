...
## Hardware
Per robot:
- 5x Robomaster M2006 P36 BDDC motors (ran on custom Steelbar Robotics Brushless Motor Drivers)
...
3. run either attack.py (striker robot), or defense.py (goalie robot)
